...
import com.oscarsalguero.sunshine.data.WeatherContract;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String temperatureUnits = PreferenceManager
                ...
                .getString(mContext.getString(R.string.pref_temperature_units_key), mContext.getString(R.string.pref_temperature_units_metric));
        if (temperatureUnits.equalsIgnoreCase(mContext.getString(R.string.pref_temperature_units_imperial))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!temperatureUnits.equalsIgnoreCase(mContext.getString(R.string.pref_temperature_units_metric))) {
